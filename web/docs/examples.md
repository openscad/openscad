...
![Step by step animation of the PythonSCAD GUI where the following script is created](pictures/box_anim.gif)
...
[![Screenshot of the PythonSCAD GUI showing the QR code generator design](pictures/qrcode.png)](pictures/qrcode.png)


or [Using Figlet 3D Ascii art](examples/figlet.txt)

[![Screenshot of the PythonSCAD GUI showing the Figlet 3D ASCII art design](pictures/figlet.png)](pictures/figlet.png)


> or [A Gyroid](examples/gyroid.txt)

[![Rendered animation of the gyroid design](pictures/gyroid.webp)](pictures/gyroid.webp)


or even [GDS File Parser](examples/read_gds.txt) used for creating Microchips

[![Screenshot of the PythonSCAD GUI showing the GDS file parser](pictures/read_gds.png)](pictures/read_gds.png)
...
![Rendering of the SDF example script below](pictures/sdf.png)
...
![Rendering of the collosseum design](pictures/collosseum.png)
...
Like in linear_extrude and rotate_extrude, the extruded 2D shape is always perpendicular to the extrusion. The syntax is:
...
![Rendering of the path extrude example script below](pictures/path_extrude.png)
...
[![Screenshot of the PythonSCAD GUI showing the 3D offset example](pictures/offset.png)](pictures/offset.png)
...
[![Rendering of the fillet example below](pictures/fillet.png)](pictures/fillet.png)
