...
void Preferences::updateGUI()
{
	...
	this->checkBoxEnableAutocomplete->setChecked(getValue("editor/enableAutocomplete").toBool());
	this->lineEditCharacterThreshold->setText(getValue("editor/characterThreshold").toString());
