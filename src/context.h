...
public:
	...
	void setVariables(const AssignmentList &args, const class EvalContext *evalctx = nullptr, bool silentOverwrite=true);

	void set_variable(const std::string &name, const ValuePtr &value, bool silentOverwrite=true);
	void set_variable(const std::string &name, const Value &value, bool silentOverwrite=true);
	void set_constant(const std::string &name, const ValuePtr &value);
	void set_constant(const std::string &name, const Value &value);

	void apply_variables(const Context &other,  bool silentOverwrite=true);
