...
public:
	...
	AbstractNode *instantiateWithFileContext(const std::shared_ptr<class FileContext> ctx, const ModuleInstantiation *inst, std::shared_ptr<EvalContext> evalctx) const;
