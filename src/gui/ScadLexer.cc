...
ScadLexer::ScadLexer(QObject *parent) : QsciLexerCPP(parent)
{
  ...
  keywordSet[1] =
    ...
    "timer_new timer_start timer_clear timer_stop timer_elapsed timer_format timer_delete timer_run "
    "dxf_dim dxf_cross";
...
void Lex::default_rules()
{
  ...
  std::string functions(
    ...
    "dxf_cross timer_new timer_start timer_clear timer_stop timer_elapsed timer_format timer_delete timer_run "
