 ...
 *   Consider P1 to be the point on the (infinite) line 1 which is closest to (infinite) line 2.
 `dist_lat`
 ...
 *   on (infinite) line 1 to (infinite) line 2 lies within the line segment l1.
     When using the parametric line equation v = v1 * t.v2, dist_lat is t.
 ...
 * actual distance (not ratio) between Line 1 and the point l2b, as calculated by
