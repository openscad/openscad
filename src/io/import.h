...
class Polygon2d *import_svg(double fn, double fs, double fa, const std::string& filename, const double dpi, const bool center, const std::string& selected_id, const Location& loc);
#ifdef ENABLE_CGAL
