...
public:
	...
	std::string text, font, direction, language, script, halign, valign;
        ...
        hb_script_t get_script(hb_glyph_info_t *glyph_info, unsigned int glyph_count) const;
        hb_direction_t get_direction(const hb_script_t script) const;
    ...
    public:
        ...
        double x_offset;
        double y_offset;
        TextMetrics(const FreetypeRenderer::Params&);
    };
    class FontMetrics {
    public:
        bool ok;    // true if object is valid
        ...
        FontMetrics(const FreetypeRenderer::Params&);
    };
    FreetypeRenderer();
...
private:
    ...
    public:
        ...
        double ascent;
        double descent;
        ShapeResults(const FreetypeRenderer::Params &);
