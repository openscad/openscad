...
static void draw_triangle(const RendererUtils::ShaderInfo *shaderinfo, const Vector3d& p0, const Vector3d& p1, const Vector3d& p2,
                          bool e0, bool e1, bool e2, double z, bool mirror)
{
  RendererUtils::ShaderType type =
    (shaderinfo) ? shaderinfo->type : RendererUtils::ShaderType::NONE;
  ...
  switch (type) {
  case RendererUtils::ShaderType::EDGE_RENDERING:
    if (mirror) {
    ...
    break;
  default:
  case RendererUtils::ShaderType::SELECT_RENDERING:
...
static void gl_draw_triangle(const RendererUtils::ShaderInfo *shaderinfo, const Vector3d& p0, const Vector3d& p1, const Vector3d& p2, bool e0, bool e1, bool e2, double z, bool mirrored)
{
...
void render_surface(const PolySet& ps, const Transform3d& m, const RendererUtils::ShaderInfo *shaderinfo)
{
