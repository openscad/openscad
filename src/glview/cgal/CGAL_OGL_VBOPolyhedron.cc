...
inline void CGAL_GLU_TESS_CALLBACK CGAL_OGL_VBOPolyhedron::beginCallback(GLenum which, GLvoid *user) {
...
inline void CGAL_GLU_TESS_CALLBACK CGAL_OGL_VBOPolyhedron::endCallback(GLvoid *user) {
  auto *tess(static_cast<TessUserData *>(user));
...
inline void CGAL_GLU_TESS_CALLBACK CGAL_OGL_VBOPolyhedron::errorCallback(GLenum errorCode) {
...
inline void CGAL_GLU_TESS_CALLBACK CGAL_OGL_VBOPolyhedron::vertexCallback(GLvoid *vertex, GLvoid *user) {
...
inline void CGAL_GLU_TESS_CALLBACK CGAL_OGL_VBOPolyhedron::combineCallback(GLdouble coords[3], GLvoid *[4], GLfloat [4], GLvoid **dataOut) {
...
void CGAL_OGL_VBOPolyhedron::draw(Vertex_iterator v, VertexArray& vertex_array) const {
...
void CGAL_OGL_VBOPolyhedron::draw(Edge_iterator e, VertexArray& vertex_array) const {
...
void CGAL_OGL_VBOPolyhedron::draw(Halffacet_iterator f, VertexArray& vertex_array, bool is_back_facing) const {
...
void CGAL_OGL_VBOPolyhedron::create_polyhedron() {
...
void CGAL_OGL_VBOPolyhedron::draw(bool showedges) const {
