...
private:
  ...
  // Cleanup idea: Put functions and modules in astNodes too. The names of them aren't used and the order isn't preserved anyway and there's no deduping for nodes. And, it's only used for printing.
