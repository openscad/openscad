...
SettingsEntryString Settings::mouseConfigPreset("mouseConfig", "preset", "OpenSCAD");
SettingsEntryString Settings::mouseConfigLeftClick("mouseConfig", "preset", "OpenSCAD");
...
SettingsEntryInt Settings::inputMousePreset("inputMouse", "preset", 0, MouseConfig::Preset::NUM_PRESETS, MouseConfig::Preset::OPEN_SCAD);
SettingsEntryInt Settings::inputMouseLeftClick("inputMouse", "leftClick", 0, MouseConfig::ViewAction::NUM_VIEW_ACTIONS, MouseConfig::presetSettings.at(MouseConfig::Preset::OPEN_SCAD).at(MouseConfig::MouseAction::LEFT_CLICK));
SettingsEntryInt Settings::inputMouseMiddleClick("inputMouse", "middleClick", 0, MouseConfig::ViewAction::NUM_VIEW_ACTIONS, MouseConfig::presetSettings.at(MouseConfig::Preset::OPEN_SCAD).at(MouseConfig::MouseAction::MIDDLE_CLICK));
SettingsEntryInt Settings::inputMouseRightClick("inputMouse", "rightClick", 0, MouseConfig::ViewAction::NUM_VIEW_ACTIONS, MouseConfig::presetSettings.at(MouseConfig::Preset::OPEN_SCAD).at(MouseConfig::MouseAction::RIGHT_CLICK));
SettingsEntryInt Settings::inputMouseShiftLeftClick("inputMouse", "shiftLeftClick", 0, MouseConfig::ViewAction::NUM_VIEW_ACTIONS, MouseConfig::presetSettings.at(MouseConfig::Preset::OPEN_SCAD).at(MouseConfig::MouseAction::SHIFT_LEFT_CLICK));
SettingsEntryInt Settings::inputMouseShiftMiddleClick("inputMouse", "shiftMiddleClick", 0, MouseConfig::ViewAction::NUM_VIEW_ACTIONS, MouseConfig::presetSettings.at(MouseConfig::Preset::OPEN_SCAD).at(MouseConfig::MouseAction::SHIFT_MIDDLE_CLICK));
SettingsEntryInt Settings::inputMouseShiftRightClick("inputMouse", "shiftRightClick", 0, MouseConfig::ViewAction::NUM_VIEW_ACTIONS, MouseConfig::presetSettings.at(MouseConfig::Preset::OPEN_SCAD).at(MouseConfig::MouseAction::SHIFT_RIGHT_CLICK));
