...
std::shared_ptr<AbstractNode> UserModule::instantiate(const std::shared_ptr<const Context>& defining_context, ModuleInstantiation *inst, const std::shared_ptr<const Context>& context) const
{
