...
void MainWindow::setIconScheme(const QString &scheme)
{
	...
	initActionIcon(fileActionNew, "images/" + set + "/dark/New.png", "images/" + set + "/light/New.png");
	initActionIcon(fileActionOpen, "images/"+ set + "/dark/Open.png", "images/" + set + "/light/Open.png");
	initActionIcon(fileActionSave, "images/"+ set + "/dark/Save.png", "images/" + set +"/light/Save.png");
	initActionIcon(editActionZoomTextIn, "images/"+ set +"/dark/ZoomTextIn.png", "images/" + set +"/light/ZoomTextIn.png");
	initActionIcon(editActionZoomTextOut, "images/"+ set +"/dark/ZoomTextOut.png", "images/" + set +"/light/ZoomTextOut-white.png");
	initActionIcon(designActionRender, "images/" + set +"/dark/Render.png", "images/" + set +"/light/Render.png");
	initActionIcon(viewActionShowAxes, "images/" + set +"/dark/ShowAxes.png", "images/" + set +"/light/ShowAxes.png");
	initActionIcon(viewActionShowEdges, "images/" + set +"/dark/ShowEdges.png", "images/"+ set +"/light/ShowEdges.png");
	initActionIcon(viewActionZoomIn, "images/" + set + "/dark/ZoomIn.png", "images/" + set + "/light/ZoomIn.png");
	initActionIcon(viewActionZoomOut, "images/" + set + "/dark/ZoomOut.png", "images/"+ set +"/light/ZoomOut.png");
	initActionIcon(viewActionTop, "images/" + set + "/dark/Top.png", "images/" + set +"/light/Top.png");
	initActionIcon(viewActionBottom, "images/" + set + "/dark/Bottom.png", "images/" + set +"/light/Bottom.png");
	initActionIcon(viewActionLeft, "images/" + set +"/dark/Left.png", "images/" + set +"/light/Left.png");
	initActionIcon(viewActionRight, "images/" + set +"/dark/Right.png", "images/" + set +"/light/Right.png");
	initActionIcon(viewActionFront, "images/" + set +"/dark/Front.png", "images/" + set +"/light/Front.png");
	initActionIcon(viewActionBack, "images/" + set + "/dark/Back.png", "images/" + set +"/light/Back.png");
	initActionIcon(viewActionSurfaces, "images/" + set +"/dark/Surfaces.png", "images/"+set+"/light/Surfaces.png");
	initActionIcon(viewActionWireframe, "images/" + set +"/dark/Wireframe.png", "images/" + set +"/light/Wireframe.png");
	initActionIcon(viewActionShowCrosshairs, "images/" + set +"/dark/ShowCrosshairs.png", "images/"+ set +"/light/ShowCrosshairs.png");
	initActionIcon(viewActionPerspective, "images/" + set + "/dark/Perspective.png", "images/"+ set +"/light/Perspective.png");
	initActionIcon(viewActionOrthogonal, "images/" + set + "/dark/Orthogonal.png", "images/" + set +"/light/Orthogonal.png");
	initActionIcon(designActionPreview, "images/" + set + "/dark/Preview.png", "images/" + set +"/light/Preview.png");
	initActionIcon(viewActionAnimate, "images/" + set +"/dark/Animate.png", "images/" + set +"/light/Animate.png");
	initActionIcon(fileActionExportSTL, "images/" + set + "/dark/ExportSTL.png", "images/" + set +"/light/ExportSTL.png");
	initActionIcon(fileActionExportAMF, "images/" + set +"/dark/ExportAMF.png", "images/" + set +"/light/ExportAMF.png");
	initActionIcon(fileActionExportOFF, "images/" + set + "/dark/ExportOFF.png", "images/" + set +"/light/ExportOFF.png");
	initActionIcon(fileActionExportDXF, "images/" + set + "/dark/ExportDXF.png", "images/" + set +"/light/ExportDXF.png");
	initActionIcon(fileActionExportSVG, "images/" + set +"/dark/ExportSVG.png", "images/" + set +"/light/ExportSVG.png");
	initActionIcon(fileActionExportCSG, "images/" + set +"/dark/ExportCSG.png", "images/" + set +"/light/ExportCSG.png");
	initActionIcon(fileActionExportImage, "images/" + set +"/dark/ExportImage.png", "images/"+ set +"/light/ExportImage.png");
	initActionIcon(viewActionViewAll, "images/" + set + "/dark/ViewAll.png", "images/" + set +"/light/ViewAll.png");
	initActionIcon(editActionUndo, "images/" + set +"/dark/Undo.png", "images/"+ set +"/light/Undo.png");
	initActionIcon(editActionRedo, "images/" + set +"/dark/Redo.png", "images/"+ set +"/light/Redo.png");
	initActionIcon(editActionUnindent, "images/" + set +"/dark/Unindent.png", "images/"+ set +"/light/Unindent.png");
	initActionIcon(editActionIndent, "images/" + set + "/dark/Indent.png", "images/" + set +"/light/Indent.png");
	initActionIcon(viewActionResetView, "images/" + set +"/dark/ResetView.png", "images/" + set +"/light/ResetView.png");
	initActionIcon(viewActionShowScaleProportional, "images/"+ set +"/dark/ShowScaleProportional.png", "images/" + set + "/light/ShowScaleProportional.png");
}
