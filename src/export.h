...
bool export_png(const shared_ptr<const class Geometry> &root_geom, Camera &c, std::ostream &output, bool &show_edges);
bool export_png(const shared_ptr<const class CGAL_Nef_polyhedron> &root_N, Camera &c, std::ostream &output, bool &show_edges);
