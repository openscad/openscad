...
bool export_png(const shared_ptr<const class Geometry> &root_geom, Camera &c, std::ostream &output, bool showaxes, bool showscale, bool showcrosshairs);
bool export_png(const shared_ptr<const class CGAL_Nef_polyhedron> &root_N, Camera &c, std::ostream &output, bool showaxes, bool showscale, bool showcrosshairs);
bool export_png_with_opencsg(Tree &tree, Camera &c, std::ostream &output, bool showaxes, bool showscale, bool showcrosshairs);
bool export_png_with_throwntogether(Tree &tree, Camera &c, std::ostream &output, bool showaxes, bool showscale, bool showcrosshairs);
