/**
 * Loader generated by glad 2.0.4 on Mon Jul  3 10:54:17 2023
 *
 ...
 *
 * Commandline:
 *    --merge --api='wgl=1.0' --extensions='WGL_ARB_extensions_string,WGL_EXT_extensions_string' c --alias --header-only --loader
 *
 * Online:
 *    http://glad.sh/#api=wgl%3D1.0&extensions=WGL_ARB_extensions_string%2CWGL_EXT_extensions_string&generator=c&options=MERGE%2CALIAS%2CHEADER_ONLY%2CLOADER
 *
 */
