...
SettingsEntry Settings::axisTrim0("input", "axisTrim0", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim1("input", "axisTrim1", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim2("input", "axisTrim2", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim3("input", "axisTrim3", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim4("input", "axisTrim4", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim5("input", "axisTrim5", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim6("input", "axisTrim6", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim7("input", "axisTrim7", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim8("input", "axisTrim8", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisTrim9("input", "axisTrim9", RangeType(-1.0,0.01, 1.0), Value(0.00));
SettingsEntry Settings::axisDeadzone0("input", "axisDeadzone0", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone1("input", "axisDeadzone1", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone2("input", "axisDeadzone2", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone3("input", "axisDeadzone3", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone4("input", "axisDeadzone4", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone5("input", "axisDeadzone5", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone6("input", "axisDeadzone6", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone7("input", "axisDeadzone7", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone8("input", "axisDeadzone8", RangeType(0.0,0.01, 1.0), Value(0.10));
SettingsEntry Settings::axisDeadzone9("input", "axisDeadzone9", RangeType(0.0,0.01, 1.0), Value(0.10));
}
