...
AbstractNode *BendModule::instantiate(const Context *ctx, const ModuleInstantiation *inst, EvalContext *evalctx) const
{
	...
	ValuePtr fixed = c.lookup_variable("fixed");
	ValuePtr cyl = c.lookup_variable("cyl");
