# Generated by cmake from /Users/ochafik/Documents/GitHub/openscad/tests/CTestCustom.template
#
...
set(ENV{OPENSCADPATH} "/Users/ochafik/Documents/GitHub/openscad/tests/../libraries")
...
if( Darwin MATCHES "Linux|BSD")
 ...
 if(DISPLAY_ENV)
  ...
  execute_process(
   COMMAND /Users/ochafik/Documents/GitHub/openscad/tests/virtualfb.sh OUTPUT_VARIABLE SVFB_OUT)
  ...
  set(CTEST_CUSTOM_POST_TEST "/Users/ochafik/Documents/GitHub/openscad/tests/virtualfb.sh")
 endif()
endif()

# Part 2. Pretty Printing

message("running '/Users/ochafik/Documents/GitHub/openscad/build_integ_dbg/tests/../OpenSCAD.app/Contents/MacOS/OpenSCAD --info' to generate sysinfo.txt")
execute_process(COMMAND /Users/ochafik/Documents/GitHub/openscad/build_integ_dbg/tests/../OpenSCAD.app/Contents/MacOS/OpenSCAD --info OUTPUT_FILE sysinfo.txt)

if("${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION}.${CMAKE_PATCH_VERSION}" VERSION_LESS 2.8.12)
  set(CTEST_CUSTOM_POST_TEST ${CTEST_CUSTOM_POST_TEST} "/Users/ochafik/Documents/GitHub/openscad/build_integ_dbg/tests/test_pretty_print")
else()
  set(CTEST_CUSTOM_POST_TEST ${CTEST_CUSTOM_POST_TEST} "/usr/local/bin/python3 \"/Users/ochafik/Documents/GitHub/openscad/tests/test_pretty_print.py\" --builddir=/Users/ochafik/Documents/GitHub/openscad/build_integ_dbg/tests ")
endif()
