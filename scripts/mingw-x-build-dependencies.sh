...
if [ "`echo $* | grep 64`" ]; then
 ...
 if [ "`echo $* | grep download`" ]; then
  PACKAGES='download-qtbase download-qtmultimedia download-qscintilla2 download-mpfr download-eigen download-opencsg download-cgal download-qtbase download-glib download-libxml2 download-freetype download-fontconfig download-harfbuzz'
 else
 ...
 if [ "`echo $* | grep download`" ]; then
  PACKAGES='download-qtbase download-qtmultimedia download-qscintilla2 download-mpfr download-eigen download-opencsg download-cgal download-qtbase download-nsis download-glib download-libxml2 download-freetype download-fontconfig download-harfbuzz'
 else
