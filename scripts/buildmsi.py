...
def main(openscad_crossbuild_dir, openscad_srcdir, openscad_version, arch ):
	print('build MSI for openscad')
	print('openscad_crossbuild_dir',openscad_crossbuild_dir)
	print('openscad_srcdir',openscad_srcdir)
	...
	if 'clean' in ''.join(sys.argv[1:]):
		for f in 'filelist.txt',filelistwxs_filename,msi_filename:
	...
	cmd+=['--define','OPENSCADSRCDIR='+openscad_srcdir]
