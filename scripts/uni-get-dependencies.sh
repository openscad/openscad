...
get_debian_deps()
{
 apt-get -y install \
  ...
  gtk-doc-tools libglib2.0-dev gettext xvfb pkg-config ragel libtbb-dev nettle-dev 
 apt-get -y install libgl1-mesa-dev libxi-dev libfontconfig-dev libzip-dev libglm-dev
}
