...
mkdir SCAD.iconset
sips -z 16 16     SCAD.png --out SCAD.iconset/icon_16x16.png
sips -z 32 32     SCAD.png --out SCAD.iconset/icon_16x16@2x.png
sips -z 32 32     SCAD.png --out SCAD.iconset/icon_32x32.png
sips -z 64 64     SCAD.png --out SCAD.iconset/icon_32x32@2x.png
sips -z 128 128   SCAD.png --out SCAD.iconset/icon_128x128.png
sips -z 256 256   SCAD.png --out SCAD.iconset/icon_128x128@2x.png
sips -z 256 256   SCAD.png --out SCAD.iconset/icon_256x256.png
sips -z 512 512   SCAD.png --out SCAD.iconset/icon_256x256@2x.png
sips -z 512 512   SCAD.png --out SCAD.iconset/icon_512x512.png
cp SCAD.png SCAD.iconset/icon_512x512@2x.png
iconutil -c icns SCAD.iconset
rm -R SCAD.iconset
